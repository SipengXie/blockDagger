...
type Message interface {
	...
	CheckNonce() bool
	Data() []byte
	AccessList() erigonTypes.AccessList
...
func IntrinsicGas(data []byte, accessList erigonTypes.AccessList, isContractCreation bool, isHomestead, isEIP2028, isEIP3860 bool) (uint64, error) {
