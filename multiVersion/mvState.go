...
func (mvs *MultiVersionState) InsertVersion(addr common.Address, hash common.Hash, version *Version) {
...
// addr : 地址
// hash : BALANCE, NONCE, CODE, CODEHASH, ALIVE, SLOTS
func (mvs *MultiVersionState) GetHeadVersion(addr common.Address, hash common.Hash) *Version {
	cache, _ := mvs.ChainMap.LoadOrStore(addr, sync.Map{})
	vc, _ := cache.(*sync.Map).LoadOrStore(hash, NewVersionChain())
...
func (mvs *MultiVersionState) GarbageCollection() {}
